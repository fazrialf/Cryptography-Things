...
public class VCFrame extends javax.swing.JFrame{
    public VCFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try{
            ...
            java.util.logging.Logger.getLogger(VCFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
